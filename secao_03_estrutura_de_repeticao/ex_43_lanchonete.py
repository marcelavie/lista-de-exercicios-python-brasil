...
def fechar_conta(*itens):
    ...
    precot = quantidadet = 0
    codigo_nome ={'100': 'Cachorro Quente', '101': 'Bauru Simples', '102': 'Bauru com Ovo', '103': 'Hamburger', '104': 'Cheeseburger', '105': 'Refrigerante'}
    ...
    print('|---------------------------------------------------------------------------|')
    print('| Total Geral:'.ljust(49), f'|{quantidadet:>11} |{precot:>11.2f} |')
    print('-----------------------------------------------------------------------------')
